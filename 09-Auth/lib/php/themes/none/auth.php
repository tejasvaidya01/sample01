<?php
// lib/php/themes/none/auth.php 20150101 - 20170307
// Copyright (C) 2015-2017 Mark Constable <markc@renta.net> (AGPL-3.0)

class Themes_None_Auth extends Themes_None_Theme
{
...
error_log(__METHOD__);
        ...
        return '
          ...
          <form action="' . $this->g->self . '" method="post">
            ...
            <p>
              <a href="?o=auth">&laquo; Back</a>
              <button type="submit" name="m" value="create">Send</button>
            </p>
          </form>';
    }
        ...
        return '
          ...
          <form action="' . $this->g->self . '" method="post">
            ...
            <p>
              ...
              <button type="submit" name="m" value="read">Sign in</button>
            </p>
          </form>';
    }
...
error_log(__METHOD__);
        ...
        return '
          ...
          <form action="' . $this->g->self . '" method="post">
            ...
            <p>
              <button type="submit" name="m" value="update">Update my password</button>
            </p>
          </form>';
    }
}

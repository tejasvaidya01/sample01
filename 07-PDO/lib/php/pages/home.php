...
Comments and pull requests are most welcome via the Issue Tracker link above.
      ...
      <p>
        '.($t->a('https://github.com/markc/simple-php7-examples', 'Project Page')).'
        '.($t->a('https://github.com/markc/simple-php7-examples/issues', 'Issue Tracker')).'
      </p>';
